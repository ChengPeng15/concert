...
<body>
	...
	<section id="main" class="column">
		...
		<div class="tab_container">
			...
			<input type="image" disabled="disabled" src="../images/seats.png" value="seat" style="margin: 20px auto"></input>
			</div>
			...
			<table>
			<tr><td>
			<a href="../admin/control_panel.html" class="a-btn animate " style="margin-left: 180px" >
				<span class="a-btn-text" style="width: 75px;">Finish</span>
